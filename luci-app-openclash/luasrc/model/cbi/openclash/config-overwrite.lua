...
m.pageaction = false
m.description = translate("For More Useful Meta Core Functions Go Wiki")..": ".."<a href='javascript:void(0)' onclick='javascript:return winOpen(\"https://wiki.metacubex.one/\")'>"..translate("Click to the page").."</a>"
