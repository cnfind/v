...
o:value("h3://223.5.5.5/dns-query", translate("Aliyun Public DNS (DNS over H3/1)"))
o:value("h3://223.6.6.6/dns-query", translate("Aliyun Public DNS (DNS over H3/2)"))
o:depends("custom_local_dns", "1")
...
o:value("h3://1.1.1.1/dns-query", translate("CloudFlare Public DNS (DNS over H3/1)"))
o:value("h3://1.0.0.1/dns-query", translate("CloudFlare Public DNS (DNS over H3/2)"))
o:depends("configfile", "/var/etc/mosdns.json")
