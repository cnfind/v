...
return view.extend({
	...
	render: function (basic) {
		...
		o.value('192.168.2.1', _('LocalHost Public DNS (192.168.2.1)'));
		o.value('223.5.5.5', _('Aliyun Public DNS (223.5.5.5)'));
		o.value('223.6.6.6', _('Aliyun Public DNS (223.6.6.6)'));
		o.value('119.29.29.29', _('Tencent Public DNS (119.29.29.29)'));
		o.value('119.28.28.28', _('Tencent Public DNS (119.28.28.28)'));
		o.value('183.221.253.100', _('China Mobile Public DNS (183.221.253.100)'));
		o.value('211.137.96.205', _('China Mobile Public DNS (211.137.96.205)'));
		o.value('h3://223.5.5.5/dns-query', _('Aliyun Public DNS (DNS over H3/1)'));
		o.value('h3://223.6.6.6/dns-query', _('Aliyun Public DNS (DNS over H3/2)'));
		o.default = '223.5.5.5';
		o.depends('custom_local_dns', '1');

		o = s.taboption('basic', form.DynamicList, 'remote_dns', _('Remote DNS server'));
		o.value('127.0.0.1:7878', _('LocalProxy Public DNS (127.0.0.1:7878)'));
		...
		o.value('h3://1.1.1.1/dns-query', _('CloudFlare Public DNS (DNS over H3/1)'));
		o.value('h3://1.0.0.1/dns-query', _('CloudFlare Public DNS (DNS over H3/2)'));
